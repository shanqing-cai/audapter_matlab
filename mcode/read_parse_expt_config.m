...
items={ {'SUBJECT_ID', 'str'}, ...
        ...
        {'SHOW_KIDS_ANIM', 'num'}, ...
        {'PERT_MODE', 'str'}, ...        
        {'PITCH_SHIFT_SEMITONES_RAND', 'num'}, ...
        {'PITCH_SHIFT_SEMITONES_SUST', 'num'}, ...
        {'SHIFT_RATIO_RAND_LOWER_F1', 'num'}, ...
        {'SHIFT_RATIO_RAND_LOWER_F2', 'num'}, ...
        {'SHIFT_RATIO_RAND_HIGHER_F1', 'num'}, ...
        {'SHIFT_RATIO_RAND_HIGHER_F2', 'num'}, ...
        {'SHIFT_RATIO_SUST_F1', 'num'}, ...
        {'SHIFT_RATIO_SUST_F2', 'num'}, ...
        {'MOUTH_MIC_DIST', 'num'}, ...
        {'SPL_TARGET', 'num'}, ...
        {'SPL_RANGE', 'num'}, ...
        {'VOWEL_LEN_TARG', 'num'}, ...
        ...
        {'PRACT2_REPS', 'num'}, ...
        {'RAND_BLOCKS', 'num'}, ...
        {'RAND_TRIALS_PER_BLOCK', 'num'}, ...
        {'RAND_LOWER_TRIALS_PER_BLOCK', 'num'}, ...
        {'RAND_HIGHER_TRIALS_PER_BLOCK', 'num'}, ...
        {'SUST_START_REPS', 'num'}, ...
        {'SUST_RAMP_REPS', 'num'}, ...
        {'SUST_STAY_REPS', 'num'}, ...
        {'SUST_END_REPS', 'num'}, ...
